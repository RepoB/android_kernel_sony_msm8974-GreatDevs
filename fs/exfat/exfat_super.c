...
static ssize_t exfat_direct_IO(int rw, struct kiocb *iocb, struct iov_iter *iter, loff_t offset)
{
...
#else
        ret = blockdev_direct_IO(rw, iocb, inode, inode->i_sb->s_bdev, iter, offset, exfat_get_block, NULL);
#endif
